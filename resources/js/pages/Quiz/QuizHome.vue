    ...
    <div class="container">
      <div class="content">
        ...
        <div class="side">
          ...
          <img class="okinawa_icon" src="./../../../images/haib.png" />
          <br />
          <p class="quiz_title">Okinawa</p>

          <div class="quiz_menu">
            <ul>
              <li class="quiz_nav">
                <span>
                  <a href="#item-center">クイズへ</a>
                </span>
              </li>
              <li class="quiz_nav">
                <span>
                  <a href="#item_site">サイトの説明</a>
                </span>
              </li>
              <li class="quiz_nav">
                <span>
                  <a href="#item_info">お知らせ</a>
                </span>
              </li>
            </ul>
          </div>
          <div class="fotter_sns">
            ...
            <a
              href="https://www.facebook.com/sharer.php?src=http://ok-okinawa-quiz.herokuapp.com/&t=沖縄クイズ"
              title="Facebookでシェア"
            ...
            <a
              href="https://twitter.com/intent/tweet?url=http://ok-okinawa-quiz.herokuapp.com/&text=沖縄クイズ"
              target="blank_"
            >
        ...
        <div class="main">
          ...
          <div class="slider-outer">
            <div class="main_text">
              <ul>
                <li class="pc">沖縄を世界へ</li>
                <li class="tel">脳のシワがふえる旅とは、面白い</li>
              </ul>
            </div>
          ...
          <!--サイトの説明-->
          <div id="item_site"></div>
          <div class="item_bottom">
            <h1 class="title-border">サイトの説明</h1>
            <div>
              <p>
                初めましてこのサイトを制作したものです。
          ...
          <div class="item_bottom">
            ...
            <div>
              <p class="info">1. カテゴリー別でクイズ出題できるようになりました.</p>
...
.fotter_sns .fa-facebook-f:hover {
  -webkit-transform: rotateX(360deg);
  transform: rotateX(360deg);
  color: #4966a0;
}
.fotter_sns .fa-twitter:hover {
  -webkit-transform: rotateX(360deg);
  transform: rotateX(360deg);
  color: #1da1f3;
}
...
.item-center ul li:nth-child(1) {
  margin-left: 40px;
}
.item-center ul li:nth-child(2) {
  /*text-align: right;*/
  width: 30vw;
  margin-left: 40px;
}
.item-center ul li span {
  font-size: 2rem;
  font-weight: lighter;
}
.item-center ul li img {
  opacity: 0.9;
  width: 30vw;
  height: 60vh;
}
